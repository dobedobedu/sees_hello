        ...
        >
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-600 mt-1">{provider.desc}</div>
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-lg font-semibold">Voice Input Settings</h2>
            </div>
              ...
              {settings.voiceEnabled && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-[#d4a017] focus:border-[#d4a017]"
                  >
                    <option value="api">API-based Whisper (Uses selected provider)</option>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2">
                ...
                <span className="text-sm text-gray-500">12 stories loaded</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-gray-700">Faculty Profiles</span>
                <span className="text-sm text-gray-500">8 profiles loaded</span>
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-gray-700">School Facts</span>
                <span className="text-sm text-gray-500">24 facts loaded</span>
              </div>
            </div>
